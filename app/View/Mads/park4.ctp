...
<?php echo $this->Html->link('Im coming', array('controller'=>'mads', 'action'=>'park4'),array( 'class' => 'button')); ?>
<?php echo $this->Html->link('Im going', array('controller'=>'mads', 'action'=>'park5'),array( 'class' => 'button')); ?>
