...
<?php echo $this->Html->link('park1',array('controller'=>'mads', 'action'=>'park1'), array('class' => 'view_dialog')); ?>
</p>
</div>
<div>
...
<?php echo $this->Html->link('park2',array('controller'=>'mads', 'action'=>'park1'), array('class' => 'view_dialog')); ?>
</p>
</div>
<div>
...
<?php echo $this->Html->link('park3',array('controller'=>'mads', 'action'=>'park1'), array('class' => 'view_dialog')); ?>
</p>
</div>
...
<?php echo $this->Html->link('park4',array('controller'=>'mads', 'action'=>'park1'), array('class' => 'view_dialog')); ?>
</div>