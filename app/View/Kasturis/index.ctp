...
<?php echo $this->Html->link('Kas World',array('controller'=>'kasturis', 'action'=>'kas1'), array('class' => 'view_dialog')); ?>
</p>
</div>
<div>
...
<?php echo $this->Html->link('Kas World1',array('controller'=>'kasturis', 'action'=>'kass2'), array('class' => 'view_dialog')); ?>
</p>
</div>
<div>
...
<?php echo $this->Html->link('Kas World2',array('controller'=>'kasturis', 'action'=>'kas3'), array('class' => 'view_dialog')); ?>
</p>
</div>
...
<?php echo $this->Html->link('Kas World3',array('controller'=>'kasturis', 'action'=>'kas4'), array('class' => 'view_dialog')); ?></p>
</div>