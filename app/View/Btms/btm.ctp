...
<?php echo $this->Html->link('parki1',array('controller'=>'btms', 'action'=>'parki1'), array('class' => 'view_dialog')); ?>
</p>
</div>
<div>
...
<?php echo $this->Html->link('parki2',array('controller'=>'btms', 'action'=>'parki1'), array('class' => 'view_dialog')); ?>
</p>
</div>
<div>
...
<?php echo $this->Html->link('parki3',array('controller'=>'btms', 'action'=>'parki1'), array('class' => 'view_dialog')); ?>
</p>
</div>
...
<?php echo $this->Html->link('parki4',array('controller'=>'btms', 'action'=>'parki1'), array('class' => 'view_dialog')); ?>
</div>