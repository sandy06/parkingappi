...
<?php echo $this->Html->link('par1',array('controller'=>'ejips', 'action'=>'par1'), array('class' => 'view_dialog')); ?>
</p>
</div>
<div>
...
<?php echo $this->Html->link('par2',array('controller'=>'ejips', 'action'=>'par1'), array('class' => 'view_dialog')); ?>
</p>
</div>
<div>
...
<?php echo $this->Html->link('par3',array('controller'=>'ejips', 'action'=>'par1'), array('class' => 'view_dialog')); ?>
</p>
</div>
...
<?php echo $this->Html->link('par4',array('controller'=>'ejips', 'action'=>'par1'), array('class' => 'view_dialog')); ?>
</div>